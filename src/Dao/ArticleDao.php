...
class ArticleDao{
    ...
    function addArticle(Article $article)
    {
        ...
        $req = $this->pdo->prepare("INSERT INTO article (title, description) VALUES (:title, :description)");
    ...
    function getArticleById($id): ?Article{
        ...
        $req = $this->pdo->prepare("SELECT * FROM article WHERE id_article = :id");
        $req->bindValue(":id",$id);
        $req->execute();
    ...
    function deleteArticle(int $id): void{
        ...
        $req = $this->pdo->prepare("DELETE FROM article 
